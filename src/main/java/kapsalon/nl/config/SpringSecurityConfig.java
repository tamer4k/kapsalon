...
public class SpringSecurityConfig {
    ...
    protected SecurityFilterChain filter (HttpSecurity http) throws Exception {
        ...
        http
                ...
                .requestMatchers(HttpMethod.PUT,"/api/v1/diensten/**").hasAnyRole("OWNER")
                .requestMatchers(HttpMethod.DELETE,"/api/v1/diensten/**").hasAnyRole("OWNER")
                                // Barber
                ...
                .requestMatchers(HttpMethod.PUT,"/api/v1/barbers/**").hasAnyRole("OWNER","BARBER")
                .requestMatchers(HttpMethod.DELETE,"/api/v1/barbers/**").hasAnyRole("OWNER")
                                // Kapsalon
                ...
                .requestMatchers(HttpMethod.PUT,"/api/v1/kapsalon/**").hasAnyRole("OWNER")
                .requestMatchers(HttpMethod.DELETE,"/api/v1/kapsalon/**").hasAnyRole("OWNER")
                                // Appointment
                ...
                .requestMatchers(HttpMethod.PUT,"/api/v1/appointment/**").hasAnyRole("CUSTOMER")
                .requestMatchers(HttpMethod.DELETE,"/api/v1/appointment/**").hasAnyRole("BARBER","CUSTOMER")
