        ...
        http
                ...
                .authorizeHttpRequests(auth ->
                        auth
                                ...
                                .requestMatchers(HttpMethod.GET,"/api/v1/barbers").hasAnyRole("OWNER")
                                .requestMatchers(HttpMethod.GET,"/api/v1/barbers/{id}").hasAnyRole("OWNER")
                                ...
                                .requestMatchers(HttpMethod.GET,"/api/v1/appointment/{id}").hasAnyRole("OWNER","CUSTOMER")
                                ...
                                .requestMatchers(HttpMethod.DELETE,"/api/v1/appointment/{id}").hasAnyRole("CUSTOMER","OWNER")
