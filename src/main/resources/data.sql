...
INSERT INTO users (first_name, second_name, email, phone_number) VALUES('John', 'Doe', 'john.doe@example.com', '+1234567890');
INSERT INTO users (first_name, second_name, email, phone_number) VALUES('Alice', 'Smith', 'alice.smith@example.com', '+9876543210');
INSERT INTO users (first_name, second_name, email, phone_number) VALUES('Bob', 'Johnson', 'bob.johnson@example.com', '+1112233445');
...
INSERT INTO appointment (appointment_date, appointment_time, barber_id,dienst_id ,user_id,kapsalon_id) VALUES('2023-01-15', '10:30', 1,1,1,1);
